...
//class 4 XML-Handling
    ...
    public:
        ...
        //friend void CreateGuiNode(IXMLDOMNode* node);
...
//--------------------------
        ...
        std::wstring WCHARToString(const wchar_t* wstr) {
            return wstr ? std::wstring(wstr) : L"";
        }
    ...
    private:
        ...
        //Speichert Messdaten pro Card_Item
                    //std::vector<std::wstring> MeasurementData;
