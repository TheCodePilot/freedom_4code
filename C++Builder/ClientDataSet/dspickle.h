...
class FLDCNested : public FLDConv
{
public:
   BOOL      bConvert;

   FLDCNested();
   FLDCNested(BOOL bConvert);
   ~FLDCNested();
...
class FLDCAlwaysNull : public FLDConv
{
public:
   BOOL      bConvert;

   FLDCAlwaysNull();
   FLDCAlwaysNull(BOOL bConvert);
   ~FLDCAlwaysNull();
...
class FLDCUnicode : public FLDConv
{
public:
   BOOL      bConvert;

   FLDCUnicode();
   FLDCUnicode(UINT32 iSize);
   ~FLDCUnicode();
...
class FLDCBinary : public FLDConv
{
public:
   BOOL      bConvert;

   FLDCBinary();
   FLDCBinary(UINT32 iSize);
   ~FLDCBinary();
