...
// Returns > 0 if record iRecNo1 is greater than key at sequence number iPos
// iPos is a sequence number in the piOrder array
INT32 DSIDX::IdxComp(UINT32 iRecNo1, UINT32 iFields, UINT32 iPos)
{
   ...
   if (ppFldObjs == NULL)
      return 0;
   if (IdxDesc.iFields && IdxDesc.iFields < iFields)
      iFields = IdxDesc.iFields;
