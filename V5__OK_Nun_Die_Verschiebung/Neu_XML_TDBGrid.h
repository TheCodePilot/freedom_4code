...
__published:	// Von der IDE verwaltete Komponenten
	...
	void __fastcall DBGrid4XMLCard_ItemMouseEnter(TObject *Sender);
	...
	void __fastcall DBGrid4XMLCard_ItemMouseMove(TObject *Sender, TShiftState Shift,
          int X, int Y);
	void __fastcall SBDBGridUserChoiceEndDrag(TObject *Sender, TObject *Target, int X,
          int Y);
	void __fastcall SBUserGridMouseMove(TObject *Sender, TShiftState Shift, int X, int Y);
	void __fastcall DBGrid4XMLCard_ItemStartDrag(TObject *Sender, TDragObject *&DragObject);
...
private:	// Benutzer-Deklarationen
	...
	void __fastcall UpdateUserGridError(); //BisherFehlerhaft
	void __fastcall UpdateUserGrid();
    void __fastcall UpdateUserGridBisher();
...
public:		// Benutzer-Deklarationen
	...
	//TEST//
	int TESTcounter_SAussen;
	int TESTcounter_SInnen;
